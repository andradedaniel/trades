                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <h4 class="panel-title">
                                        {{--<a data-toggle="collapse" data-parent="#accordion" href="#collapse{{$count}}"><strong>{{ $trade->data->format('d/m/Y') }}</strong></a>--}}
                                        <a data-toggle="collapse" href="#collapse{{$count}}"><strong>{{ $trade->data->format('d/m/Y') }}</strong></a>
                                    </h4>
                                </div>
                                <div class="col-sm-1">
                                    @if ($trade->tipo == 'buy')
                                ...
                                <div class="col-sm-1 text-right"><h4 class="panel-title"><a data-toggle="collapse" href="#collapse{{$count}}">{{ $trade->getPrecoMedioEntrada() }}</a></h4></div>
                                ...
                                <div class="col-sm-1 text-right"><h4 class="panel-title">
                                        <a href="" id="closeTrade" name="closeTrade" data-toggle="modal" data-target="#closeTradeFormModal"> <i class='fa fa-check fa-3' aria-hidden="true"></i></a>&nbsp;&nbsp;
